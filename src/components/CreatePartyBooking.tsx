    ...
    if (bookingData.createGroupChat) {
      try {
        ...
        try {
          ...
          // Fallback: Still book the party and go to community
          toast.success('Party Booked! 🎉', {
            description: `You've got ${bookingData.numberOfTickets} ticket(s). You can chat in the community! 💬`,
          });
        ...
        console.error('Error in party booking:', error);
